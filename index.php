...
<!-- Mirrored from demo.graygrids.com/themes/plain-bs/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2017 17:05:03 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <!-- Header area wrapper starts -->
    ...
    <section id="portfolio">
     ...
     <!--- <div class="controls text-center">
      ...
      <center>
          <a href="#" class="btn btn-common btn-lg" style="margin-bottom: 20px;">
                  
                  View All
                  <i class="fa fa-chevron-right pr-10">
                  </i>
      </a></center>
    </section>
        ...
        <div class="row">
          ...
          <!-- Service-Block-1 Item Starts -->
            <div class="service-item wow fadeInUpQuick animated" data-wow-delay=".5s">
              ...
              <p>
                We Provide relationship with industries which is perfect Match of your requirement.
              </p>
          ...
          <div class="col-sm-6 col-md-3 text-center">
            ...
            <div class="service-item wow fadeInUpQuick animated" data-wow-delay=".8s">
              ...
              <p>
                We give you better interface in community. We build your power to stay iin touch.
              </p>
              <a href="#" class="btn btn-common">
                Read More
              </a>
          ...
          <div class="col-sm-6 col-md-3 text-center">
            ...
            <div class="service-item wow fadeInUpQuick animated" data-wow-delay="1.1s">
              ...
              <p>
                  We will make your services available to world wide. We will give you great platform to you.
              </p>
              <a href="#" class="btn btn-common">
                Read More
              </a>
          ...
          <div class="col-sm-6 col-md-3 text-center">
            ...
            <div class="service-item  wow fadeInUpQuick animated" data-wow-delay="1.4s">
              ...
              <p>
                We will grow-up your business. We will support to fly on heights to achieve your dreams.
              </p>
              <a href="#" class="btn btn-common">
                Read More
              </a>
          ...
          <div class="row">
            ...
            <div class="our-progress text-center">
              <div class="col-md-3 progress-item wow bounceIn" data-wow-delay=".2s">
                ...
                <p>
                  You can get start with JOBWORK INDIA by register with us. 
                </p>
              </div>
              <div class="col-md-3 progress-item progress-bottom wow bounceIn" data-wow-delay=".5s">
                ...
                <p>
                  Add requirements for service you want with Details.
                </p>
              </div>
              <div class="col-md-3 progress-item wow bounceIn" data-wow-delay=".8s">
                ...
                <p>
                  We will provide you List of service provider. You can select your choice for Estimate
                </p>
              </div>
              <div class="col-md-3 progress-item progress-bottom wow bounceIn" data-wow-delay="1.3s">
                ...
                <h3>
                  Get Connection for free
                </h3>
                <p>
                  Give you access and find perfect match of your service request for free of cost.
                </p>
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeIn" data-wow-delay="0.3s">
              ...
              <div class="blog-item-text">
                <a href="#">
                  <h3>
                    Mechanical Turning Job
                  </h3>
                </a>
                <p>
                  Turning Operation for Product
                </p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeIn" data-wow-delay="0.6s">
              ...
              <div class="blog-item-text">
                <a href="#">
                  <h3>
                    Factory Electrical Work
                  </h3>
                </a>
                <p>
                   Looking for Guide to arrange this for my factory.
                </p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeIn" data-wow-delay="0.9s">
              ...
              <div class="blog-item-text">
                ...
                <p>
                   Need some to clear wasted of col from factory.
                </p>
                <div class="blog-item-info">
                  <a href="#">
                    <i class="fa fa-clock-o">
